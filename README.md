...
#### БД PostgreSQL реализована с помощью Docker контейнера.
Для поднятия контейнера с БД и запуска приложения необходимо предварительно 
запустить Docker Desktop. После этого запустить файл _run-app.sh_.
